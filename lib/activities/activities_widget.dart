...
class ActivitiesWidget extends StatefulWidget {
  ...
  final DocumentReference? identityplay;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ActivitiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ActivitiesRecord> activitiesActivitiesRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final activitiesActivitiesRecord =
            activitiesActivitiesRecordList.isNotEmpty
                ? activitiesActivitiesRecordList.first
                : null;
