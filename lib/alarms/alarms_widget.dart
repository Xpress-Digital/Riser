                        ...
                        Expanded(
                          child: StreamBuilder<List<AlarmRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<AlarmRecord> listViewAlarmRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                itemCount: listViewAlarmRecordList.length,
                                itemBuilder: (context, listViewIndex) {
                                  final listViewAlarmRecord =
                                      listViewAlarmRecordList[listViewIndex];
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context
                                            .pushNamed('AudioPlayer_identity');
                                      },
                                      child: Container(
                                        width:
