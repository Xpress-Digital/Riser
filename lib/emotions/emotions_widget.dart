              ...
              Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      StreamBuilder<List<EmotionsRecord>>(
                        stream: queryEmotionsRecord(
                          queryBuilder: (emotionsRecord) =>
                              emotionsRecord.orderBy('Number'),
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<EmotionsRecord> listViewEmotionsRecordList =
                              snapshot.data!;
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              final listViewEmotionsRecord =
                                  listViewEmotionsRecordList[listViewIndex];
                              return Padding(
