            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 10.0, 3.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    StreamBuilder<List<AffirmationRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<AffirmationRecord>
                                            dropDownAffirmationRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final dropDownAffirmationRecord =
                                            dropDownAffirmationRecordList
                                                    .isNotEmpty
                                                ? dropDownAffirmationRecordList
                                                    .first
                                        ...
                                        return FlutterFlowDropDown<String>(
                                          ...
                                          onChanged: (val) async {
                                            ...
                                            FFAppState().affirmationCategories =
                                                FFAppState()
